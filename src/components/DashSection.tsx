        ...
        <span className="flex items-center gap-1.5 shrink-0">
          ...
          {customize && onAdd && (
            <button
              ...
              className="w-7 h-7 grid place-items-center rounded border border-signal/50 text-signal cursor-pointer hover:bg-signal/15 hover:shadow-[0_0_10px_rgba(63,169,104,0.3)] transition-all duration-150 focus-visible:outline-2 focus-visible:outline-signal"
            >
